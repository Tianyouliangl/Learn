package com.senyint.ihospital.client

import com.senyint.ihospital.HttpConfig
import com.senyint.ihospital.interceptor.AddGlobalParamInterceptor
import com.senyint.ihospital.utils.NetLog
import okhttp3.*
...
object HttpClient {
    ...
    private val mStrRetrofit by lazy {
        Retrofit.Builder()
                ...
                .baseUrl(HttpConfig.getBaseUrl())
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .addConverterFactory(com.senyint.ihospital.client.StringConverterFactory())
                .build()
    }
    ...
    fun getLongHttpClient(): OkHttpClient = mLongTimeHttpClient
