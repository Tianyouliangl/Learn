...
public class ImSendMessageUtils {
    ...
    public static String getPid() {
        ...
        stringBuffer.append("CHAT")
                ...
                .append(getRandomString())
                .append(getRandomInt())
                .append(time.substring(time.length() - 4));
    ...
    public static String getChatMessageImage(String body, String fromId, String toId, String pid, String conversation, int displaytime) {
        JSONObject object = new JSONObject();
        try {
            object.put("fromId", fromId);
            object.put("toId", toId);
    ...
    public static String getChatMessageLocation(String body, String fromId, String toId, String pid, String conversation, int displaytime) {
        JSONObject object = new JSONObject();
        try {
            object.put("fromId", fromId);
            object.put("toId", toId);
    ...
    public static String getChatMessageVoice(String filename, String fileAbsPath, long voiceTime, String fromId, String toId, String pid, String conversation, int displaytime) {
        JSONObject object = new JSONObject();
        try {
            object.put("fromId", fromId);
            object.put("toId", toId);
