...
import com.learn.commonalitylibrary.UpLoadFileBean;
...
public class FileUpLoadManager {
    ...
    private String DEF_FILEPATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/learn/voice/";
        ...
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> emitter) throws Exception {
                ...
                if (response.isSuccessful()) {
                    ...
                    //储存下载文件的目录
                    File dir = new File(DEF_FILEPATH);
                    if (!dir.exists()) {
                        dir.mkdirs();
                    }
