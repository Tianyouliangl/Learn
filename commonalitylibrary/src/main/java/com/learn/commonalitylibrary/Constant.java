...
public class Constant {
    public static String BASE_GROUP_URL = "http://192.168.2.169:8082/"; //172.16.201.143  //111.229.231.206   192.168.2.169
    public static String BASE_CHAT_URL =   "http://192.168.2.169:9092/";   // im连接地址
